      ...
      <div className="surface-glass border-glass p-6 md:p-8 rounded-[32px] relative overflow-hidden">
        ...
        <div className="flex flex-col items-center text-center gap-4 mb-8">
          ...
          <div className="space-y-1 w-full">
            <h1
              className="text-xl md:text-2xl font-bold tracking-tight text-white line-clamp-2 px-2"
        ...
        {file.files && file.files.length > 0 && (
          <div className="mb-6 space-y-2">
            <span className="font-mono text-[10px] text-indigo-400 uppercase tracking-widest block mb-1">
              Share Collection ({file.files.length}{" "}
              {file.files.length === 1 ? "item" : "items"})
            </span>
                ...
                >
                  <div className="flex items-center gap-2.5 overflow-hidden">
                    ...
                    <div className="overflow-hidden">
                      <p
                        className="text-xs font-semibold text-white truncate max-w-[160px] sm:max-w-[200px]"
                  ...
                  <button
                    type="button"
                    onClick={() =>
                      handleIndividualDownload(sub.id, sub.originalName)
                    }
        ...
        <div className="grid grid-cols-2 gap-3 mb-8">
          <div className="bg-white/2 border border-white/5 p-4 rounded-xl flex flex-col gap-1">
            <span className="font-mono text-[9px] text-orange-400 uppercase tracking-wider opacity-80">
              Transient Status
            </span>
          ...
          <div className="bg-white/2 border border-white/5 p-4 rounded-xl flex flex-col gap-1">
            <span className="font-mono text-[9px] text-indigo-400 uppercase tracking-wider opacity-80">
              Availability
            </span>
            <div className="flex items-center gap-1.5 text-white">
