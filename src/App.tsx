...
type ViewState = 'main' | 'success' | 'download' | 'admin' | 'error';
...
export default function App() {
    ...
    const handleUrlQuery = async () => {
      ...
      if (code) {
        ...
        try {
          ...
          setErrorText(err.message || 'The secure link is invalid or has expired.');
  ...
  const handleNavigate = (view: 'main' | 'admin' | 'download-input') => {
    setErrorText('');
        ...
        {currentView === 'error' && (
          <div className="max-w-lg mx-auto px-4 py-16 text-center space-y-6">
            ...
            <div className="space-y-2">
              <h1 className="text-2xl font-bold tracking-tight text-[#ffb4ab]">Code Expired or Invalid</h1>
              <p className="text-slate-400 text-sm leading-relaxed">
                {errorText || "The transient link you are trying to access has been cleared from our systems, or it reached its download limit."}
              </p>
            </div>
